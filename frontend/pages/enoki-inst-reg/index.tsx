...
export default function JoinEnokiInstance() {
      ...
      const res = await queryClient.fetchQuery({
        ...
        queryFn: async () => {
          const res = await axios.post(
            `${process.env.NEXT_PUBLIC_API}/join-institution`,
            {
  ...
  if (isSuccess) {
    return (
      <>
        <Head>
          <title>Enoki Instance Registration</title>
        ...
        >
          ...
          >
            ...
            <p className="text-gray-600 mb-4">
              You have successfully joined the instance for{" "}
              <strong>{formData.institutionId}</strong>.
            </p>
