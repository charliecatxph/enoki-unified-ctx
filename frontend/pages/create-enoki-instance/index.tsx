...
export default function CreateEnokiInstance({ user }: { user: any }) {
      ...
      const res = await queryClient.fetchQuery({
        ...
        queryFn: async () => {
          const res = await axios.post(
            `${process.env.NEXT_PUBLIC_API}/create-institution`,
            {
  ...
  if (isSuccess) {
    return (
      <>
        <Head>
          <title>E-Noki - Instance Created Successfully!</title>
          <link rel="icon" href="/favicon.ico" />
        </Head>
        <div
          className={`${poppins.className} min-h-screen bg-gradient-to-br from-green-50 via-blue-50 to-indigo-50 flex items-center justify-center p-4`}
        >
          <motion.div
          ...
          >
            ...
            <p className="text-gray-600 mb-4">
              Your Enoki instance for <strong>{formData.schoolName}</strong> has
              been created.
            </p>
  ...
  return (
    <>
      <Head>
        <title>E-Noki - Create Enoki Instance</title>
        <link rel="icon" href="/favicon.ico" />
      </Head>
      <div
        className={`${poppins.className} min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 flex items-center justify-center p-4`}
      >
        <motion.div
