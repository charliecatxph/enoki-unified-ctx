...
export default function Navbar() {
  ...
  useEffect(() => {
    const handleClickOutside = (event: MouseEvent) => {
      if (apkDropdownRef.current && !apkDropdownRef.current.contains(event.target as Node)) {
        setIsApkDropdownOpen(false);
      }
      if (mobileApkDropdownRef.current && !mobileApkDropdownRef.current.contains(event.target as Node)) {
          ...
          <div className="hidden md:flex items-center space-x-4">
            ...
            <div className="relative" ref={apkDropdownRef}>
              ...
              >
                ...
                <svg 
                  className={`w-4 h-4 transition-transform duration-200 ${isApkDropdownOpen ? 'rotate-180' : ''}`}
                  fill="none" 
                  stroke="currentColor" 
                  viewBox="0 0 24 24"
                >
                  ...
                  <div className="p-2">
                    ...
                    >
                      ...
                      <div className="flex-1 text-left">
                        <div className="font-semibold text-gray-900">E-Noki Production</div>
                        <div className="text-sm text-gray-500">Version 1.2.0 • Stable Release</div>
                        <div className="text-xs text-gray-400 mt-1">Optimized for production use</div>
                      </div>
                      <div className="flex-shrink-0">
                    ...
                    >
                      ...
                      <div className="flex-1 text-left">
                        <div className="font-semibold text-gray-900">E-Noki Development</div>
                        <div className="text-sm text-gray-500">Version 1.3.0-beta • Latest Features</div>
                        <div className="text-xs text-gray-400 mt-1">For testing and development</div>
                      </div>
                      <div className="flex-shrink-0">
                        <svg className="w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
          ...
          <div className="px-4 py-6 space-y-4 bg-black/20 backdrop-blur-md rounded-lg mt-4">
            ...
            <div className="relative" ref={mobileApkDropdownRef}>
              ...
              >
                ...
                <svg 
                  className={`w-4 h-4 transition-transform duration-200 ${isMobileApkDropdownOpen ? 'rotate-180' : ''}`}
                  fill="none" 
                  stroke="currentColor" 
                  viewBox="0 0 24 24"
                >
                ...
                <div className="mt-2 bg-white rounded-lg shadow-lg border border-gray-200">
                  <div className="p-2">
                    ...
                    >
                      ...
                      <div className="flex-1 text-left">
                        <div className="font-semibold text-gray-900 text-sm">E-Noki Production</div>
                        <div className="text-xs text-gray-500">Version 1.2.0 • Stable</div>
                      </div>
                    </button>
                    ...
                    >
                      ...
                      <div className="flex-1 text-left">
                        <div className="font-semibold text-gray-900 text-sm">E-Noki Development</div>
                        <div className="text-xs text-gray-500">Version 1.3.0-beta • Latest</div>
                      </div>
                    </button>
                  </div>
                </div>
